...
class LawfulDMapAPI (γ : Type u) (α : Type v) (β : α → Type w) [inst : DMapAPI γ α β] extends
    LawfulDMapLike γ α β, LawfulIsEmptySize γ, LawfulContainsMem γ α where
...
local instance LawfulDMapAPI_of_LawfulMapAPI' {γ α β} [inst : MapAPI γ α β] [instL : LawfulMapAPI γ α β] :
